        ...
        <DialogContent dividers>
          <Box sx={{ display: "grid", gap: 2, mt: 1 }}>
            ...
            <Box>
              ...
              <Typography variant="body1">{formData.campus}</Typography>
            </Box>
            <Box>
              <Typography variant="caption" color="text.secondary">College</Typography>
              <Typography variant="body1">{formData.college}</Typography>
            </Box>
            <Box>
            ...
            <Box>
              ...
              <Typography variant="body1">{formData.yearLevel}</Typography>
            </Box>
            {editable ? (
